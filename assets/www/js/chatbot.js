...
Appyscript.onPageInit('chatbot-page',function(page){
      ...
      if (mainView.activePage.name=="chatbot-page")
                            {
                            $$("#btn-input").focus();
                      ...
                      ApiAIPlugin.init(
                                                             {
                                                             clientAccessToken: pageData.chatbot_client_1, // insert your client access key here
                      ...
                      <div class="chat-message chat-left '+pageData.styleAndNavigation.systemChat[0]+' '+ pageData.styleAndNavigation.systemChat[1] +'">\
                      ...
                      var date=getCurrentTime();
                      var html='<div class="chat-container">\
                      <div class="chat-message chat-right '+pageData.styleAndNavigation.userChat[0]+' '+ pageData.styleAndNavigation.userChat[1] +'">\
                      <div class="chat-message-content">\
