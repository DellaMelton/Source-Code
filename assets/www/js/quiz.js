...
Appyscript.onPageInit('quiz-PageMain',function(page){
                       ...
                       */
                      quizServiceUrl=webserviceUrl+'Quiz.php';
                      quizTimeLimit=0;
                      quizTimeCounter=0;
                      quizElapsedTime=0;
                      totalQuizQuestion=0;
...
function startQuizMain(a) {
     console.log("iden  "+pageIdentifie)
...
function calculateQuizTime (value) {
  ...
  var skipped_question_store;
  var quuestion_Not_Attempt_store;
  var quizElapsedTime_store;
...
quiz_final_score_server=quiz_final_score;
    if(pageData.randomQuection=="0"){
     ...
     if(localStorage.getItem("toCheckValue") != "htmlValueCheck" )
               {
                         skipped_question_store=skipped_question;
                        quuestion_Not_Attempt_store=quuestion_Not_Attempt;
                        quizElapsedTime_store= calculateQuizTime(quizElapsedTime);
               ...
               {
                     quizElapsedTime_store=quizElapsedTime_store;
                    detailsHtml='<li>'+ pageData.setting.questionsasked +' '+randomQuestionLength
                       +'</li><li>'+ pageData.setting.questionscorrect +' '+correct_questions
                       +'</li><li>'+ pageData.setting.questionsincorrect +' '+incorrect_question
                       +'</li><li>'+ pageData.setting.skip +' '+skipped_question_store
                       +'</li><li>'+ pageData.setting.notattempted +' '+(quuestion_Not_Attempt_store);
                       //+(randomQuestionLength-quiz_max_queId)
               }
        ...
        if(quizTimeLimit > 0){
            detailsHtml=detailsHtml+'</li><li>'+ pageData.setting.timeelapsed +' '+quizElapsedTime_store;
        }
         ...
         detailsHtml=detailsHtml+'</li><li>'+ pageData.setting.finalscore +' '+quiz_final_score
                 +'%</li><li>'+ text +'</li><li>'+ pageData.setting.passingscoretxt +' '+quiz_passing_score+'%</li>';
//        detailsHtml=detailsHtml+'</li><li>'+ pageData.setting.finalscore +' '+quiz_final_score
...
function quizIOSShare(quiz_final_score) {
    ...
    var urlstr = "https://itunes.apple.com/lookup?bundleId="+bundelId;
    var urlstr = "https://itunes.apple.com/lookup?bundleId="+bundelId;
    Appyscript.showIndicator();
    if(isOnline()){
    $$.ajax({
