                        ...
                        if(pageData.list[loyaltyCardData.index].dailyLimitStatus==1){
                            ...
                            if(timeArr.length>=pageData.list[loyaltyCardData.index].dailyLimit){
                                ...
                                console.log("ernfesrhgvuserhgviurstghiritghdityhjoitdyjhiotyohjtoyirjo"+timeArr.length);
                                         var  dailyLimitCheck = currentTimeDate.getDate()-oldDate.getDate();
...
//                            var monthsFull = ('January February March April May June July August September October November December').split(' ');
...
//
//
//                             if(newDate.indexOf("January") > -1)
//                             {
//                              newDate = newDate.replace("January",data.languageSetting.January);
//
//                             }
//                               else if(newDate.indexOf("February") > -1)
//                              {
//                             newDate = newDate.replace("February",data.languageSetting.February);
//                              }
//                              else if(newDate.indexOf("March") > -1)
//                               {
//                               newDate = newDate.replace("March",data.languageSetting.March);
//                               }
//                            else if(newDate.indexOf("April") > -1)
//                               {
//                               newDate = newDate.replace("April",data.languageSetting.April);
//                                }
//                                else if(newDate.indexOf("May") > -1)
//                                  {
//                                  newDate = newDate.replace("May",data.languageSetting.May);
//                                }
//                                else if(newDate.indexOf("June") > -1)
//                               {
//                                 newDate = newDate.replace("June",data.languageSetting.June);
//                             }
//
//                              else if(newDate.indexOf("July") > -1)
//                               {
//                                 newDate = newDate.replace("July",data.languageSetting.July);
//                              }
//                               else if(newDate.indexOf("August") > -1)
//                               {
//                                 newDate = newDate.replace("August",data.languageSetting.August);
//                                 }
//                                else if(newDate.indexOf("September") > -1)
//                                  {
//                                 newDate = newDate.replace("September",data.languageSetting.September);
//                                 }
//                                 else if(newDate.indexOf("October") > -1)
//                                 {
//                                  newDate = newDate.replace("October",data.languageSetting.October);
//                                    }
//                                 else if(newDate.indexOf("November") > -1)
//                                  {
//                                   newDate = newDate.replace("November",data.languageSetting.November);
//                                  }
//                                   else
//                                    {
//                                 newDate = newDate.replace("December",data.languageSetting.December);
//                                   }
//
...
//                {
                ...
                //mainView.router.back();
                    ...
                    console.log("totalback   "+totalback +"    pagelengthBack   "+pagelengthBack)
                    Appyscript.hideIndicator();
                    Appyscript.alert(pageData.languageSetting.congratulationsuccessfullredeemdloyaltycard);
...
//                screenRefresh();    Commented for Alert Issue for ONe Time Use in loyalty.
...
//      navigator.device.capture.captureImage(captureSuccessDirectoryy, captureErrorDirectory, options);
          Appyscript.showIndicator();
         navigator.camera.getPicture(captureSuccessDirectoryy, captureErrorDirectory, {
            quality: 50,
...
//    navigator.device.capture.captureImage(captureSuccessDirectory, captureErrorDirectory, options);
            Appyscript.showIndicator();
            navigator.camera.getPicture(captureSuccessDirectory, captureErrorDirectory, {
                    quality: 70,
                    destinationType: Camera.DestinationType.FILE_URI,
                    sourceType: Camera.PictureSourceType.CAMERA,
                    encodingType: Camera.EncodingType.JPEG,
...
AppyTemplate.registerHelper('loyaltyDate',function (date, options) {
    ...
    var _dateValue = _dateArray[0];
    var _monthValue = parseInt(_dateArray[1]);
    var _yearValue = _dateArray[2];
...
AppyTemplate.registerHelper('loyaltyDateOld',function (date, options) {
                            date = new Date(date.split("/")[1] +"/"+date.split("/")[0] +"/"+ date.split("/")[2]);
...
//        txtValue = a.textContent || a.innerText;
        var cardName = $("#search"+i).text();
        if (cardName.toUpperCase().indexOf(filter.toUpperCase()) > -1) {
            li[i].style.display = "";
            $$("#loyaltymatcheslist").hide()
...
//var loyaltyCardFake = false;
//Appyscript.onPageInit('loyalty-page',function(page)
//                      {
//                      if(!loyaltyCardFake) {
//                      loayaltyCardFake = true;
...
Appyscript.onPageInit('loyalty-page',function(page)
{
     if(pageData.list.length > 10){
        $$(".search-box").show()
        $$("#myUL").css("margin-top","40px")
      }else{
         $$(".search-box").hide()
