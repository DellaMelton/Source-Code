...
var timesheeturl=webserviceUrl + 'TimeSheet.php';
...
Appyscript.onPageAfterAnimation('timesheet-page', function(page) {
     ...
     if (localStorage.getItem("profileImage") == "") {
       AppyTemplate.global.timesheetimage = "https://gurucul.com/wp-content/uploads/2015/01/default-user-icon-profile.png"
       } else {
